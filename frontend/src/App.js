...
function App() {
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Button variant="outline-info" href="#features">Monthly Winner</Button>
      ...
      <Form inline>
      <FormControl  type="text" placeholder="Type keyword for your search" className="mr-sm-2 ml-xl-5" />
      <Button variant="outline-success">Search</Button>
    </Form>
    </Nav>
    <Nav>
    <Button variant="outline-info" href="#make_acc">SIGN UP</Button>
